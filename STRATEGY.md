...
```mermaid
flowchart LR
  agency["Agency: Blueprint / Migration / Build / n8n"] -->|"reveals repeatable vertical patterns"| productize["Productize the repeatable one"]
  productize --> products["Products (zonikai-style vertical SaaS)"]
  products -->|"recurring revenue + IP + credibility"| agency
  testaimodels["testaimodels: eval + authority + funnel"] -->|"proves reliability, attracts agencies/AI teams"| agency
  testaimodels --> products
```
