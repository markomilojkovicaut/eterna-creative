...
function CalculatorNavPreview() {
  return (
    <div className="relative mx-auto aspect-[16/9] w-full max-w-[200px] overflow-hidden rounded-soft border border-border-dark bg-bg-base">
